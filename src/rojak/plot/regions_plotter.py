...
def create_regions_snapshot_plot(
...
def create_distance_from_a_to_b_instantaneous_lat_lon_plot(
...
def create_distance_from_a_to_b_instantaneous_waypoints_plot(
    distances_from: xr.DataArray,
    to_regions: xr.DataArray,
    plot_name: str,
    time_index: int = 0,
...
def create_mean_distances_a_to_b_lat_lon_plot(
    distances_from: xr.DataArray,
    plot_name: str,
